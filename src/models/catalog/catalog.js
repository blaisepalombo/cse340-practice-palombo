...
const courses = {
  ...
  MATH113: {
    ...
    description:
      'Fundamental algebra concepts including functions, polynomials, and equations.',
    credits: 3,
    sections: [
  ...
  ENG102: {
    ...
    department: 'English',
    description:
      'Advanced writing skills through the study of literature and critical analysis.',
    credits: 3,
    sections: [
